# Italian Learning Log

## Sessions

### 2026-04-12 — Week 1, Topic: caffè (café/bar)
- **Grammar:** essere (to be) conjugation + basic greetings (Buongiorno/Buonasera/Ciao/Arrivederci) + noun gender (il/la)
- **Roleplay scenario:** Ordering coffee at a Roman bar (Marco the barista)
- **News stories used:**
  - "In Ungheria c'è un cambiamento politico" (Orbán election defeat)
  - "Gli astronauti tornano sulla Terra" (Artemis II mission return)
  - "Gli Stati Uniti e l'Iran: un problema difficile" (Hormuz Strait standoff)
- **Pronunciation focus:** r vs ř, short vowels (caffè, pizza), hard t/n (important, tornare)

### 2026-04-12 — Week 1, Topic: caffè (café/bar) — session 2
- **Grammar:** essere + pozdravy + rod (il/la) — opakování, nová fonetika [bwon-džórno]
...
| Italian | Gender | Czech | Introduced | Source |
|---------|--------|-------|------------|--------|
| tornare | verb | vrátit se | Week 1 Day 1 | news (Artemis II) |
| nuovo/nuova | adj | nový/nová | Week 1 Day 1 | news (Maďarsko) |
